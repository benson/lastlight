...
import { DIFFICULTIES, MAPS, PASSIVES, SPECIALISTS, WEAPONS } from "./data.js?v=20260718.5";
import { Simulation, applyPlayerUpgrade } from "./engine.js?v=20260718.5";
import { ELITE_AFFIX_IDS, ENEMY_ARCHETYPE_IDS, eliteAffixEligibility } from "./enemy-archetypes.js?v=20260713.1";
import { gameplayFeatureContract } from "./feature-config.js?v=20260718.5";
import { playerBuildStats, weaponTelemetry } from "./upgrade-preview.js?v=20260718.5";
