...
The optional “pew pew pew” callout uses the browser's local speech-synthesis voice. It does not bundle or transmit a voice model or recording, is rate-limited, and can be disabled independently or reduced to zero volume.
