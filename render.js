import { SPECIALISTS, MAPS, ENEMY_TYPES, MAP_OBSTACLES, clamp } from "./data.js?v=20260713.10";
import { WORLD } from "./engine.js?v=20260713.10";
...
import { impactRenderPlan } from "./impact-grammar.js?v=20260713.10";
import { movementVisualState } from "./movement.js?v=20260713.10";
