import { BALANCE_CONFIG } from "./balance-config.js?v=20260718.5";
import { PASSIVES, SPECIALISTS, WEAPONS } from "./data.js?v=20260718.5";
import { formatProjectileDisplay, getCombatMetadata } from "./combat-metadata.js?v=20260718.5";
import { playerCombatStat, playerMovementSpeed, previewPlayerUpgrade } from "./engine.js?v=20260718.5";
import { passiveBuildcraft, sourceBuildcraft } from "./synergy-tags.js?v=20260718.5";
