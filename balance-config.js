...
import { CAMPAIGN_MUTATIONS, validateCampaignMutations } from "./campaign-mutations.js?v=20260713.20";
import { SPECIALIST_MASTERY, validateSpecialistMasteryRegistry } from "./specialist-mastery.js?v=20260713.20";
import { RARE_DISCOVERY_REGISTRY, validateRareDiscoveryRegistry } from "./rare-discoveries.js?v=20260713.20";
