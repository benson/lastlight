...
| signature:echo | meaningful | cadence, lifetime | 8850→12154 | 0.5→0.778 | lifetime | pass |
...
| signature:gale | meaningful | cadence, pierce, flow-regeneration | 4802.5→5440 | 0.278→0.333 | flow-regeneration | pass |
...
| universal:mines | meaningful | mine-grid-chain | 9990→10545 | 0.222→0.222 | mine-grid-chain | pass |
| universal:crossbow | meaningful | pierce, corridor-targeting, deep-crit | 4588.5→12402.25 | 0.389→0.389 | ballista-deep-crit | pass |
...
| universal:transit | meaningful | horizontal-corridor, cover-push | 820→4100 | 0.111→0.111 | transit-push | pass |
