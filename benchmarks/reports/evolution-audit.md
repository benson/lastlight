...
| signature:echo | meaningful | cadence, lifetime | 9204→12862 | 0.5→0.778 | lifetime | pass |
...
| signature:gale | meaningful | cadence, pierce, flow-regeneration | 4547.5→5185 | 0.278→0.333 | flow-regeneration | pass |
...
| universal:mines | meaningful | mine-grid-chain | 10175→10730 | 0.222→0.222 | mine-grid-chain | pass |
| universal:crossbow | meaningful | pierce, corridor-targeting, deep-crit | 4289.25→12003.25 | 0.389→0.389 | ballista-deep-crit | pass |
...
| universal:transit | meaningful | horizontal-corridor, cover-push | 3280→4100 | 0.111→0.111 | transit-push | pass |
