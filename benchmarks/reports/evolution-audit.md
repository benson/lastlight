...
| signature:echo | meaningful | cadence, lifetime | 9558→14632 | 0.5→0.778 | lifetime | pass |
...
| signature:gale | meaningful | cadence, pierce, flow-regeneration | 5057.5→5822.5 | 0.278→0.333 | flow-regeneration | pass |
...
| universal:mines | meaningful | mine-grid-chain | 10360→11285 | 0.222→0.222 | mine-grid-chain | pass |
| universal:crossbow | meaningful | pierce, corridor-targeting, deep-crit | 3990→12502 | 0.389→0.389 | ballista-deep-crit | pass |
