...
| signature:echo | meaningful | cadence, lifetime | 9322→11564 | 0.5→0.778 | lifetime | pass |
...
| signature:gale | meaningful | cadence, pierce, flow-regeneration | 4675→5185 | 0.278→0.333 | flow-regeneration | pass |
...
| universal:uwu | meaningful | cadence, retarget | 7644→13774.8 | 2.778→3 | needle-retarget | pass |
...
| universal:mines | meaningful | mine-grid-chain | 10175→10360 | 0.222→0.222 | mine-grid-chain | pass |
| universal:crossbow | meaningful | pierce, corridor-targeting, deep-crit | 4621.75→11803.75 | 0.389→0.389 | ballista-deep-crit | pass |
