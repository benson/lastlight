...
| signature:echo | meaningful | cadence, lifetime | 9676→12036 | 0.5→0.778 | lifetime | pass |
...
| signature:gale | meaningful | cadence, pierce, flow-regeneration | 5567.5→6077.5 | 0.278→0.333 | flow-regeneration | pass |
...
| universal:mines | meaningful | mine-grid-chain | 10175→10915 | 0.222→0.222 | mine-grid-chain | pass |
| universal:crossbow | meaningful | pierce, corridor-targeting, deep-crit | 3956.75→12402.25 | 0.389→0.389 | ballista-deep-crit | pass |
...
| universal:transit | meaningful | horizontal-corridor, cover-push | 1230→4100 | 0.111→0.111 | transit-push | pass |
