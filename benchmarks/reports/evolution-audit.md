...
Contract: `actual-simulation-paired-evolution-v1` / `fnv1a32:e64c8ff6`
...
| signature:echo | meaningful | cadence, lifetime | 9086→12272 | 0.5→0.778 | lifetime | pass |
...
| signature:gale | meaningful | cadence, pierce, flow-regeneration | 5865→6545 | 0.278→0.333 | flow-regeneration | pass |
...
| universal:uwu | meaningful | cadence, retarget | 7644→13665.6 | 2.778→3 | needle-retarget | pass |
...
| universal:mines | expected-no-op | impact-identity | 9805→9805 | 0.222→0.222 | nonCosmeticDeltaCount | expected-failure |
| universal:crossbow | meaningful | pierce, corridor-targeting, deep-crit | 3125.5→12335.75 | 0.389→0.389 | ballista-deep-crit | pass |
...
| universal:transit | expected-no-op | impact-identity | 2870→2870 | 0.111→0.111 | nonCosmeticDeltaCount | expected-failure |
