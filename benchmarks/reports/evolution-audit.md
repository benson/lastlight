...
| signature:echo | meaningful | cadence, lifetime | 9558→12862 | 0.5→0.778 | lifetime | pass |
...
| signature:gale | meaningful | cadence, pierce, flow-regeneration | 7947.5→8585 | 0.278→0.333 | flow-regeneration | pass |
...
| universal:mines | meaningful | mine-grid-chain | 9620→11100 | 0.222→0.222 | mine-grid-chain | pass |
| universal:crossbow | meaningful | pierce, corridor-targeting, deep-crit | 3757.25→12169.5 | 0.389→0.389 | ballista-deep-crit | pass |
...
| universal:transit | meaningful | horizontal-corridor, cover-push | 0→4100 | 0.111→0.111 | transit-push | pass |
