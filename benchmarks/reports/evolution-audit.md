...
| signature:echo | meaningful | cadence, lifetime | 8496→11446 | 0.5→0.778 | lifetime | pass |
...
| signature:gale | meaningful | cadence, pierce, flow-regeneration | 6587.5→7097.5 | 0.278→0.333 | flow-regeneration | pass |
...
| universal:mines | meaningful | mine-grid-chain | 9990→10915 | 0.222→0.222 | mine-grid-chain | pass |
| universal:crossbow | meaningful | pierce, corridor-targeting, deep-crit | 5519.5→11737.25 | 0.389→0.389 | ballista-deep-crit | pass |
...
| universal:transit | meaningful | horizontal-corridor, cover-push | 2460→4100 | 0.111→0.111 | transit-push | pass |
