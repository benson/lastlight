...
const operatorConfig = {
  schemaVersion: 14, configVersion: "rollback-48", gameplayVersion: "rare-discoveries-off-v1", registryVersion: "lastlight.squad-synergy.v1",
  flags: {
    ...
    mapMechanics: false,
    campaignMutations: false, specialistMastery: false, rareDiscoveries: false, challengeAchievements: false, seededOperations: false, practiceLaboratory: false,
