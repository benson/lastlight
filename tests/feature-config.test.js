...
const operatorConfig = {
  schemaVersion: 15, configVersion: "rollback-49", gameplayVersion: "rare-discoveries-off-v1", registryVersion: "lastlight.squad-synergy.v1",
  flags: {
    ...
    mapMechanics: false,
    campaignMutations: false, specialistMastery: false, rareDiscoveries: false, challengeAchievements: false, seededOperations: false, practiceLaboratory: false, accessibilityPass: false,
