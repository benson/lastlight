...
const importers = [
  ...
  "audio-cues.js", "audio-mix.js", "audio-assets.js", "music-director.js", "readability.js", "environment-interactions.js",
  "material-impacts.js", "collision-geometry.js", "environment-collision-masks.js", "terrain-props.js", "terrain-prop-slots.js", "downed-activity.js",
];
const changedTargets = new Set([
  ...
  "audio-cues.js", "audio-mix.js", "audio-assets.js", "music-director.js", "readability.js", "campaign-mutations.js",
  "quality-settings.js", "hotkeys.js",
  "material-impacts.js", "collision-geometry.js", "terrain-props.js", "terrain-prop-slots.js", "environment-collision-masks.js", "downed-activity.js",
]);
...
test("the visible and runtime build identities match the cache release", () => {
  ...
  assert.match(html, /Lastlight build 2026\.07\.18\.9/);
  assert.match(html, /<strong>2026\.07\.18\.9<\/strong>/);
  assert.match(game, /const BUILD = "2026\.07\.18\.9"/);
});
