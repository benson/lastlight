...
const RELEASE = "20260713.4";
const importers = ["index.html", "game.js", "render.js", "ping-context.js"];
const changedTargets = new Set([
  "styles.css", "game.js", "render.js", "feature-config.js", "ping-contract.js", "ping-context.js",
]);
...
test("the visible and runtime build identities match the cache release", () => {
  ...
  assert.match(html, /Lastlight build 2026\.07\.13\.4/);
  assert.match(html, /<strong>2026\.07\.13\.4<\/strong>/);
  assert.match(game, /const BUILD = "2026\.07\.13\.4"/);
});
