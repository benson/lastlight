...
const changedTargets = new Set([
  ...
  "combat-metadata.js", "impact-grammar.js", "synergy-tags.js",
  "run-archive.js", "map-mechanics.js", "environment-chunks.js", "themes/lastlight.js", "rare-discoveries.js", "challenge-achievements.js",
]);
...
test("the visible and runtime build identities match the cache release", () => {
  ...
  assert.match(html, /Lastlight build 2026\.07\.13\.17/);
  assert.match(html, /<strong>2026\.07\.13\.17<\/strong>/);
  assert.match(game, /const BUILD = "2026\.07\.13\.17"/);
});
