...
test("versioned gameplay flags can safely suppress optional objective systems", () => {
  const disabled = new Simulation({ players: [player()], features: {
    ...
    squadSynergies: false, sharedParticipationCredit: false, downedActivity: false, joinInProgressNormalization: false, squadEnemyDirector: false, registryVersion: "lastlight.squad-synergy.v1",
  } }, { seed: SEED });
  ...
  assert.throws(() => new Simulation({ players: [player()], features: {
    gameplayVersion: "events-v1", objectiveEvents: true,
    squadSynergies: false, sharedParticipationCredit: false, downedActivity: false, joinInProgressNormalization: false, squadEnemyDirector: false, registryVersion: "lastlight.squad-synergy.v1", unknown: true,
