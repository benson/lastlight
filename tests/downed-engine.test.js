...
test("feature-off preserves legacy immobility/support suppression and solo remains immediate defeat", () => {
  const legacy = new Simulation({ map: "warehouse", duration: 240, players: [
    ...
    downedActivity: false, joinInProgressNormalization: false, squadEnemyDirector: false, mapMechanics: false, campaignMutations: false, registryVersion: "lastlight.squad-synergy.v1",
  } }, { seed: SEED });
