import { SPECIALISTS, SPECIALIST_ORDER, PASSIVES, WEAPONS, MAPS, DIFFICULTIES, ENEMY_TYPES, WAVE_NAMES, BOONS, AUGMENTS, BASE_VITALITY, formatTime, clamp } from "./data.js?v=20260712.6";
import { Simulation, moveEntityWithCover, playerMovementSpeed } from "./engine.js?v=20260712.6";
import { Renderer } from "./render.js?v=20260712.6";
import { FixedStepClock, MovementPredictor } from "./feel.js?v=20260712.6";
...
import { getCurrentStatExplanation, getPassiveAffectedSources } from "./combat-metadata.js?v=20260712.6";
import { BALANCE_HASH, BALANCE_VERSION } from "./balance-config.js?v=20260712.6";
...
import { getWeaponImpactGrammar, impactSummary, resolveEntityImpact } from "./impact-grammar.js?v=20260712.6";
import { advancePlayerMovement } from "./movement.js?v=20260712.6";
import { MATERIAL_CLASSES } from "./material-impacts.js?v=20260711.8";
import { DynamicAudioMixer } from "./audio-mix.js?v=20260712.6";
import { LASTLIGHT_AUDIO_CUES, resolveAudioCue } from "./audio-cues.js?v=20260712.6";
import { audioOutputState, audioPercent, loadAudioSettings, saveAudioSettings, settleAudioResume } from "./audio-settings.js?v=20260712.6";
import { buildUpgradeComparison, signatureEvolutionTelemetry, weaponTelemetry } from "./upgrade-preview.js?v=20260712.6";
import { getWeaponEvolution } from "./weapon-evolution.js?v=20260712.6";
...
import { createGameReplayAdapters } from "./replay-game-adapters.js?v=20260712.6";
import { SPECIALIST_IDENTITY_VERSION, getSpecialistIdentity } from "./specialist-identity.js?v=20260712.6";
import { reconcileActiveBuffs } from "./active-buffs.js?v=20260712.6";
