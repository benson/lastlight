import { SPECIALISTS, SPECIALIST_ORDER, PASSIVES, WEAPONS, MAPS, DIFFICULTIES, ENEMY_TYPES, WAVE_NAMES, BOONS, AUGMENTS, BASE_VITALITY, formatTime, clamp } from "./data.js?v=20260712.3";
import { Simulation, moveEntityWithCover, playerMovementSpeed } from "./engine.js?v=20260712.3";
import { Renderer } from "./render.js?v=20260712.3";
import { FixedStepClock, MovementPredictor } from "./feel.js?v=20260712.3";
...
import { getCurrentStatExplanation, getPassiveAffectedSources } from "./combat-metadata.js?v=20260712.3";
import { BALANCE_HASH, BALANCE_VERSION } from "./balance-config.js?v=20260712.3";
...
import { getWeaponImpactGrammar, impactSummary, resolveEntityImpact } from "./impact-grammar.js?v=20260712.3";
import { advancePlayerMovement } from "./movement.js?v=20260712.3";
import { MATERIAL_CLASSES } from "./material-impacts.js?v=20260711.8";
import { DynamicAudioMixer } from "./audio-mix.js?v=20260711.10";
import { buildUpgradeComparison, signatureEvolutionTelemetry, weaponTelemetry } from "./upgrade-preview.js?v=20260712.3";
...
import { createGameReplayAdapters } from "./replay-game-adapters.js?v=20260712.3";
import { SPECIALIST_IDENTITY_VERSION, getSpecialistIdentity } from "./specialist-identity.js?v=20260712.3";
import { reconcileActiveBuffs } from "./active-buffs.js?v=20260712.3";
