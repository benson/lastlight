import { SPECIALIST_ORDER, WEAPONS } from "./data.js?v=20260711.5";
...
export const SIGNATURE_IMPACT_GRAMMAR = Object.freeze({
  ...
  sola: entry({ silhouette: "prism", material: "hard-light", motion: "linear-guard", trail: trail("double", 28, 3), contact: "shield-chip", impact: "solar-prism", decal: "sun-glyph", shake: "low", flash: "medium", soundFamily: "solar", accessibility: access("standard", palette(dark, "#f7c84b", white), "diamond-core"), behavior: "Shield-shaped bolts read as armor converted into force." }, "Lion's Light keeps the beam identity while making its armored penetration unmistakable.", { silhouette: "lion-prism", trail: trail("double", 42, 4), contact: "shield-break", impact: "crowned-prism", decal: "crowned-sun", shake: "medium", flash: "high", behavior: "A crowned diamond core and broader gold wake signal the evolved penetration." }),
  ...
  fang: entry({ silhouette: "claw-arc", material: "bio-metal", motion: "close-sweep", trail: trail("slash", 18, 4), contact: "rake", impact: "three-cut-burst", decal: "three-cuts", shake: "low", flash: "medium", soundFamily: "blade", accessibility: access("critical", palette(dark, "#ff6e55", white), "triple-slash"), behavior: "Three short cuts keep the close-range strike distinct from bullets." }, "Savage Slice adds a persistent bleed read and stronger sustain payoff.", { silhouette: "serrated-claw", trail: trail("slash", 30, 5), contact: "serrated-rake", impact: "bleedless-red-rip", decal: "serrated-cuts", shake: "medium", flash: "high", behavior: "A serrated after-cut communicates persistence without relying on blood color alone." }),
  gale: entry({ silhouette: "spiral", material: "compressed-wind", motion: "drifting-spin", trail: trail("corkscrew", 24, 2), contact: "wind-shear", impact: "curl-burst", decal: "wind-curl", shake: "none", flash: "low", soundFamily: "wind", accessibility: access("standard", palette(dark, "#9bd7ff", white), "spiral"), behavior: "Open spirals remain readable through dense projectile fields." }, "Wandering Storms pierce farther with a denser, larger funnel.", { silhouette: "double-spiral", trail: trail("corkscrew", 40, 3), contact: "deep-wind-shear", impact: "double-curl-burst", decal: "double-wind-curl", shake: "low", flash: "medium", behavior: "The second spiral and longer corkscrew wake signal extended penetration." }),
  rift: entry({ silhouette: "kinetic-wedge", material: "kinetic-light", motion: "snap-slam", trail: trail("speedline", 18, 4), contact: "wedge-hit", impact: "chevron-shock", decal: "skid-chevron", shake: "medium", flash: "medium", soundFamily: "kinetic", accessibility: access("critical", palette(dark, "#e7c53e", white), "forward-chevron"), behavior: "A forward wedge ties the strike to Rift's movement direction." }, "Golden Overrun accelerates the close-range crash into a brighter momentum loop.", { silhouette: "double-wedge", trail: trail("speedline", 34, 5), contact: "overrun-hit", impact: "double-chevron-shock", decal: "gold-skid-chevron", shake: "high", flash: "high", behavior: "Stacked chevrons and an extended skid line convey carried momentum." }),
  ...
  vesper: entry({ silhouette: "dagger", material: "polished-alloy", motion: "linear-return", trail: trail("blade-ribbon", 22, 2), contact: "blade-tick", impact: "four-point-star", decal: "pin-mark", shake: "low", flash: "medium", soundFamily: "blade", accessibility: access("standard", palette(dark, "#c05cff", white), "long-diamond"), behavior: "A narrow blade profile reads separately from energy fire." }, "Lover's Ricochet penetrates more targets and leaves a stronger recall path.", { silhouette: "winged-dagger", trail: trail("blade-ribbon", 40, 3), contact: "ricochet-tick", impact: "winged-star", decal: "paired-pin-mark", shake: "low", flash: "high", behavior: "Winglets and a longer return ribbon show the expanded ricochet path." }),
});

export const UNIVERSAL_IMPACT_GRAMMAR = Object.freeze({
  uwu: entry({ silhouette: "needle", material: "laser", motion: "rapid-linear", trail: trail("speedline", 20, 2), contact: "needle-ping", impact: "micro-star", decal: "pin-scorch", shake: "none", flash: "low", soundFamily: "pulse", accessibility: access("standard", palette(dark, "#f58cff", white), "thin-chevron"), behavior: "Short magenta needles prioritize cadence over size." }, "Twin Needle Array fires faster with piercing paired cores.", { silhouette: "twin-needle", trail: trail("double", 32, 2), contact: "double-ping", impact: "twin-star", decal: "paired-pin-scorch", flash: "medium", behavior: "Two parallel cores and a split wake communicate the array." }),
  ...
  aura: entry({ silhouette: "field-ring", material: "radiant-energy", motion: "persistent-field", trail: trail("none", 0), contact: "field-tick", impact: "soft-radial-pulse", decal: "sun-ring", shake: "none", flash: "low", soundFamily: "solar", accessibility: access("ambient", palette(dark, "#ffd861", white), "ring-with-gaps"), behavior: "A quiet broken ring avoids competing with hostile telegraphs." }, "Explosive Embrace converts the field into a stronger eruptive pulse.", { silhouette: "eruptive-field-ring", trail: trail("radial", 20, 3), contact: "flare-tick", impact: "eruptive-radial-pulse", decal: "burst-sun-ring", shake: "medium", flash: "high", accessibility: access("standard", palette(dark, "#ffb84f", white), "burst-ring"), behavior: "Outward spokes distinguish the evolved eruption from the persistent base field." }),
  mines: entry({ silhouette: "diamond-mine", material: "arc-tech", motion: "deploy-arm", trail: trail("none", 0), contact: "trigger-click", impact: "arc-burst", decal: "warning-diamond", shake: "medium", flash: "medium", soundFamily: "tech", accessibility: access("critical", palette(dark, "#ff8d55", white), "diamond-with-ticks"), behavior: "A fixed diamond and closing arming ring telegraph the fuse." }, "Tri-Mine Grid broadens the blast pattern with a stronger linked warning.", { silhouette: "tri-diamond-mine", trail: trail("link", 28, 2), contact: "grid-trigger", impact: "tri-arc-burst", decal: "linked-warning-diamonds", shake: "high", flash: "high", behavior: "Three linked diamonds communicate the evolved grid while preserving the fuse ring." }),
  crossbow: entry({ silhouette: "bolt", material: "ballistic-alloy", motion: "fan-linear", trail: trail("speedline", 24, 2), contact: "bolt-chip", impact: "splinter-star", decal: "bolt-notch", shake: "low", flash: "low", soundFamily: "ballistic", accessibility: access("standard", palette(dark, "#f7d76a", white), "barbed-line"), behavior: "Barbed gold bolts make the random fan direction legible." }, "Prime Ballista punches through a lane with a heavier barbed bolt.", { silhouette: "heavy-bolt", trail: trail("double", 38, 3), contact: "ballista-chip", impact: "heavy-splinter-star", decal: "deep-bolt-notch", shake: "medium", flash: "medium", behavior: "A wider shaft and double wake communicate the added penetration." }),
  boomerang: entry({ silhouette: "boomerang", material: "light-alloy", motion: "out-and-return", trail: trail("return-arc", 26, 3), contact: "return-slice", impact: "arc-spark", decal: "curved-cut", shake: "low", flash: "low", soundFamily: "blade", accessibility: access("standard", palette(dark, "#8cefff", white), "open-hook"), behavior: "The open hook shows travel direction at a glance." }, "Quad-o-rang increases coverage with a four-lobed return read.", { silhouette: "quad-boomerang", trail: trail("return-arc", 42, 4), contact: "quad-return-slice", impact: "four-arc-spark", decal: "four-curved-cuts", shake: "medium", flash: "medium", behavior: "Four short hook marks identify the wider evolved return pattern." }),
  rail: entry({ silhouette: "rail-crescent", material: "solar-rail", motion: "opposed-lanes", trail: trail("lane", 36, 3), contact: "rail-cut", impact: "horizontal-flare", decal: "lane-scorch", shake: "low", flash: "medium", soundFamily: "solar", accessibility: access("standard", palette(dark, "#ffcd71", white), "horizontal-bars"), behavior: "Horizontal bars reinforce the paired left-right lane behavior." }, "Enveloping Light leaves broader, brighter opposing lanes.", { silhouette: "double-rail-crescent", trail: trail("lane", 54, 4), contact: "enveloping-cut", impact: "double-horizontal-flare", decal: "double-lane-scorch", shake: "medium", flash: "high", behavior: "A second rail and longer lane mark communicate the enveloping reach." }),
  ...
  drone: entry({ silhouette: "drone-dart", material: "autonomous-tech", motion: "guided-linear", trail: trail("data-dash", 22, 2), contact: "data-ping", impact: "tech-chevron", decal: "pixel-mark", shake: "none", flash: "low", soundFamily: "tech", accessibility: access("standard", palette(dark, "#77efcf", white), "notched-chevron"), behavior: "Notched green darts remain tied to the companion's tech language." }, "Yuum.AI Final pierces farther and repairs more often with a stronger linked dart.", { silhouette: "linked-drone-dart", trail: trail("data-dash", 36, 3), contact: "linked-data-ping", impact: "double-tech-chevron", decal: "linked-pixel-mark", shake: "low", flash: "medium", behavior: "A linked double notch communicates the evolved autonomous system." }),
});
