...
export const SIGNATURE_IMPACT_GRAMMAR = Object.freeze({
  ...
  sola: entry({ silhouette: "prism", material: "hard-light", motion: "linear-guard", trail: trail("double", 28, 3), contact: "shield-chip", impact: "solar-prism", decal: "sun-glyph", shake: "low", flash: "medium", soundFamily: "solar", accessibility: access("standard", palette(dark, "#f7c84b", white), "diamond-core"), behavior: "Shield-shaped bolts read as armor converted into force." }, "Lion's Light cycles every 1.50 seconds instead of 1.75; its pierce and secondary-hit behavior do not change.", { silhouette: "lion-prism", trail: trail("double", 42, 4), contact: "shield-break", impact: "crowned-prism", decal: "crowned-sun", shake: "medium", flash: "high", behavior: "A crowned diamond core distinguishes the faster evolved beam without implying extra penetration." }),
  ...
  fang: entry({ silhouette: "claw-arc", material: "bio-metal", motion: "close-sweep", trail: trail("slash", 18, 4), contact: "rake", impact: "three-cut-burst", decal: "three-cuts", shake: "low", flash: "medium", soundFamily: "blade", accessibility: access("critical", palette(dark, "#ff6e55", white), "triple-slash"), behavior: "Three short cuts keep the close-range strike distinct from bullets." }, "Savage Slice cycles faster; it does not add bleed, another hit, or additional Frenzy healing.", { silhouette: "serrated-claw", trail: trail("slash", 30, 5), contact: "serrated-rake", impact: "serrated-rip", decal: "serrated-cuts", shake: "medium", flash: "high", behavior: "The serrated after-cut identifies the faster evolved swipe without promising a damage-over-time effect." }),
