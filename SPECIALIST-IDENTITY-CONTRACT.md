...
`specialist-identity.js` is the versioned, immutable design contract for all nine specialists. It describes mechanical intent—not selection-screen copy—and is pinned to balance version `2026.07.12-evolutions.1`.
