import { BALANCE_CONFIG, BALANCE_IDS, BALANCE_VERSION } from "./balance-config.js?v=20260712.6";
import { SPECIALISTS } from "./data.js?v=20260712.6";
...
export const SPECIALIST_IDENTITY_CONTRACT = deepFreeze({
  ...
  balanceVersion: "2026.07.12-evolutions.2",
