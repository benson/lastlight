...
const specialists = {
  zuri: {
    ...
    breakpoints: coreBreakpoints(8, 50, "haste", [{ id: "hot-streak", trigger: { kind: "kill-count", value: 70 }, effect: "70 normal kills or one elite starts 8s of +150 haste and +18% damage.", source: "engine" }]),
  },
  echo: {
  ...
  sola: {
    ...
    breakpoints: coreBreakpoints(17, 80, "armor"),
  },
  bront: {
  ...
  gale: {
    ...
    safety: { tier: "high", tools: ["long-active-dash", "self-shield", "brief-active-invulnerability"] }, control: { tier: "low", tools: ["signature-micro-stun"] }, support: { tier: "none", tools: [] },
    ...
    failureModes: [
      { id: "flow-empty", condition: "Flow is below 100 and the active is unavailable.", consequence: "The signature waits for passive flow regeneration." },
    ...
    breakpoints: coreBreakpoints(10, 25, "crit", [{ id: "flow-ready", trigger: { kind: "flow", value: 100 }, effect: "Signature can fire; passive regeneration takes about 4s from empty, while the active fills flow immediately.", source: "engine" }]),
  },
  rift: {
    ...
    durability: { tier: "high", baseHealth: 10, baseArmor: 20, sources: ["high-base-armor", "self-shield"] },
    ...
    safety: { tier: "high", tools: ["highest-base-speed", "active-dash", "self-shield", "enemy-stun"] }, control: { tier: "medium", tools: ["enemy-stun"] }, support: { tier: "low", tools: ["enemy-stun"] },
...
export const SPECIALIST_IDENTITY_CONTRACT = deepFreeze({
  ...
  balanceVersion: "2026.07.12-cover.1",
